...
static const char *translations[][RG_LANG_MAX] = {
     ...
     },
    {
     ...
     [RG_LANG_FR] =
            "Pour que ces changements prennent effet, vous devez redémarrer votre appareil.\nRedémarrer maintenant ?",                                                                                                                                                                                                     [RG_LANG_DE] = "Um die Änderungen anzuwenden muss das Gerät neu gestartet werden. \nJetzt neustarten?",
     },
    {
